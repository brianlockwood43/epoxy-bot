...
def wire_bot_runtime(
    ...
    *,
    ...
    resolve_policy_bundle_sync,
    format_policy_directive_func,
    apply_policy_enforcement_func,
    subject_user_tag,
    subject_person_tag,
    ...
    recall_profile_for_identity_func,
    ...
    command_deps = CommandDeps(
        ...
        list_candidate_memories_sync=list_candidate_memories_sync,
        approve_memory_sync=approve_memory_sync,
        reject_memory_sync=reject_memory_sync,
    ...
    register_runtime_events(
        ...
        deps=RuntimeDeps(
            ...
            recall_memory_func=recall_memory_func,
            format_memory_for_llm=format_memory_for_llm,
            resolve_policy_bundle_sync=resolve_policy_bundle_sync,
            format_policy_directive_func=format_policy_directive_func,
            apply_policy_enforcement_func=apply_policy_enforcement_func,
            recall_profile_for_identity_func=recall_profile_for_identity_func,
